...
// // // // arr=splitArray.slice();
// // // // for (var i = 0; i < input.length;i++) {
// // // // var capital=arr[i].charAt(0).toUpperCase();
// // // // var newString=capital+arr[i];

// // // // }
// // // // console.log(newString);
// // // // var newVar=input.split(' ');
// // // // console.log(input.split(' '));
// // // // console.log(newVar[0]);

// // // // var newArr2=newVar.slice();
// // // // console.log(newArr2[0].charAt(0));
...
// // // // var inp=prompt("Enter Your Fav Mobile Model?");
// // // // console.log(inp.length);

// // // // ==========QUESTION 2============
// // // // var inp=prompt("Enter Your Fav Mobile Model?");
// // // // var lenghtOFInput=inp.length;
// // // // console.log(inp.charAt(lenghtOFInput-1));
// // // // console.log(inp.length);
...
// // // // console.log("N is at "+inp.indexOf('n')+" Index");
...
// // // } else {
// // //     console.log("UserName Must Not Contain  Special Character Like @ ! , . etc");
// // // }
